...
namespace Gamelogic.Grids2
{
	...
	/// <remarks>This class should not be used directly. Instead, use
	/// <see cref="GridBehaviour{TPoint, TCell}"/>.</remarks>
	...
	/// <remarks>See <conceptualLink target="12acc43b-6ea5-4828-85bd-0f9e2f9fdd25"/> 
	/// for details on how to use grid behaviours. </remarks>
